...
public class FirstClass extends RelativeLayout {
    /** Core Items*/
    ...
    public FirstClass(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext=context;
        this.attrs=attrs;
        initView();
    ...
    public FirstClass(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView() {
        this.view=this;
        inflate(mContext, R.layout.first_layout,this);
